...
def agg_patches_kweight(patches,images,bufs,args,cs_ptr=None,denom="hw"):
    # -- default stream --
    if cs_ptr is None:
    ...
    compute_agg_batch_kweight(images.deno,vnoisy,vinds,images.weights,
                             vvals,images.vals,args.ps,args.ps_t,cs_ptr,denom=denom)


def compute_agg_batch_kweight(deno,patches,inds,weights,vals,ivals,
    ...
    exec_agg_simple_kweight(deno,patches,inds,weights,vals,ivals,ps,ps_t,denom=denom)

def exec_agg_simple_kweight(deno,patches,inds,weights,vals,ivals,ps,ps_t,denom="hw"):
    ...
    # -- exec numba --
    exec_agg_simple_kweight_numba(deno_nba,patches_nba,inds_nba,
...
@njit
def exec_agg_simple_kweight_numba(deno,patches,inds,weights,vals,
